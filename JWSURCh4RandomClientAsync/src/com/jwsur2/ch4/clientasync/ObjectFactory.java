 ...
 * generated in the com.jwsur2.ch4.clientasync package. 
...
public class ObjectFactory {
    ...
    private final static QName _NextNResponse_QNAME = new QName("http://random.ch4.jwsur2.com/", "nextNResponse");
    private final static QName _Next1Response_QNAME = new QName("http://random.ch4.jwsur2.com/", "next1Response");
    private final static QName _NextN_QNAME = new QName("http://random.ch4.jwsur2.com/", "nextN");
    private final static QName _Next1_QNAME = new QName("http://random.ch4.jwsur2.com/", "next1");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.jwsur2.ch4.clientasync
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://random.ch4.jwsur2.com/", name = "nextNResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://random.ch4.jwsur2.com/", name = "next1Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://random.ch4.jwsur2.com/", name = "nextN")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://random.ch4.jwsur2.com/", name = "next1")
