 ...
 * 
 */
@WebServiceClient(name = "RandServiceService", targetNamespace = "http://random.ch4.jwsur2.com/", wsdlLocation = "http://localhost:8080/JWSURCh4Random?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RANDSERVICESERVICE_QNAME = new QName("http://random.ch4.jwsur2.com/", "RandServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JWSURCh4Random?wsdl");
    ...
    public RandService getRandServicePort() {
        return super.getPort(new QName("http://random.ch4.jwsur2.com/", "RandServicePort"), RandService.class);
    }
    ...
    public RandService getRandServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://random.ch4.jwsur2.com/", "RandServicePort"), RandService.class, features);
    }
